                    ...
                    <div className="max-w-[1600px] mx-auto px-4 md:px-8 h-16 md:h-20 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
                            ...
                            >
                                ...
                                <span className="sm:hidden">{user ? 'Dashboard' : 'Seller Login'}</span>
                            </button>
                            <button
                ...
                <main className="flex-grow">
                    ...
                    <section className="py-16 md:py-24 relative overflow-hidden bg-[#1a202c] border-t border-[#2d3748]">
                        ...
                        >
                            ...
                            <div className="mt-8 text-sm sm:text-base text-gray-400">
                                If you are already a seller,{' '}
                                <button onClick={handleLogin} className="text-emerald-500 hover:text-emerald-400 underline underline-offset-2 font-medium hover:scale-105 transition-transform inline-block">
                                    login here
                                </button>
                            </div>
                        </m.div>
