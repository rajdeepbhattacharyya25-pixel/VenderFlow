            ...
            <main className="flex-grow max-w-[800px] mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
                ...
                <div className="prose prose-lg dark:prose-invert prose-emerald max-w-none text-gray-600 dark:text-gray-300">
                    <p className="lead text-xl mb-8">
                        Welcome to VendorFlow. By accessing our platform, you agree to be bound by these Terms and Conditions. VendorFlow is a premium, curated ecommerce infrastructure designed exclusively for verified, high-volume merchants and their customers.
                    </p>

                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-12 mb-4">1. Merchant Vetting & Eligibility</h2>
                    <p className="mb-6">
                        VendorFlow is not an open marketplace. We maintain a strict curation process to ensure customer trust and platform integrity. All prospective merchants must undergo a comprehensive business review before being granted selling privileges. We reserve the right to reject or suspend any merchant account that fails to uphold our standards for product quality, shipping timelines, or customer service at our absolute discretion.
                    </p>

                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-12 mb-4">2. Platform Usage & Infrastructure</h2>
                    <p className="mb-6">
                        We provide enterprise-grade infrastructure, secure payment routing, and localized storefronts to approved sellers. You agree not to misuse our infrastructure through automated scraping, denial-of-service attempts, or the hosting of prohibited materials. While we guarantee a 99.9% uptime SLA for verified enterprise accounts, VendorFlow is not liable for indirect losses stemming from temporary service interruptions outside of our immediate control.
                    </p>

                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-12 mb-4">3. Consumer Protection & Liability</h2>
                    <p className="mb-6">
                        While VendorFlow strictly curates its merchant network, transactions are legally bound between the buyer and the respective seller. VendorFlow provides the secure technology layer but assumes no direct liability for product defects, delivery delays, or unfulfilled promises made by individual merchants, unless explicitly stated under VendorFlow Buyer Protection policies.
                    </p>

                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-12 mb-4">4. Intellectual Property</h2>
                    <p className="mb-6">
                        The VendorFlow brand, platform architecture, dashboard UI, and underlying code are the exclusive intellectual property of VendorFlow Inc. Merchants retain full ownership of their storefront data, product imagery, and brand assets uploaded to our servers, granting us a limited license purely to display and promote their products within the VendorFlow ecosystem.
                    </p>
