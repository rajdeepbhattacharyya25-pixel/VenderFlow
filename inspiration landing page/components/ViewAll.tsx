...
export const ViewAll: React.FC<ViewAllProps> = ({ 
  ...
  return (
    <div className="max-w-[1600px] mx-auto px-4 md:px-8 pt-6 md:pt-10 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row items-end md:items-center justify-between gap-4 mb-8 sticky top-[65px] md:relative z-30 bg-white/95 dark:bg-background-dark/95 backdrop-blur-sm py-4 md:py-0 -mx-4 px-4 md:mx-0 md:px-0 transition-all border-b md:border-none border-gray-100 dark:border-gray-800 md:bg-transparent">
        <div>
      ...
      {filteredProducts.length > 0 ? (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-3 gap-y-6 md:gap-x-5 md:gap-y-8 pb-10">
