...
export const Checkout: React.FC<CheckoutProps> = ({ items, onPlaceOrder, onNavigateCart, onNavigateHome }) => {
  ...
  const savedAddresses = [
    { id: 1, name: 'Alex Doe', type: 'Home', address: '123 Fashion Ave, New York, NY 10001', phone: '+1 (555) 123-4567' },
    { id: 2, name: 'Alex Doe', type: 'Work', address: '456 Tech Blvd, San Francisco, CA 94105', phone: '+1 (555) 987-6543' },
  ];
  ...
  const shippingCost = deliveryMethod === 'express' ? 299 : (subtotal > 2500 ? 0 : 199);
        ...
        <div className="lg:col-span-7 space-y-8 animate-in slide-in-from-left-4 duration-500">
          ...
          <section>
            ...
            <div className="space-y-4">
              {/* Saved Addresses */}
              {!isNewAddress && savedAddresses.map(addr => (
                <label 
                  key={addr.id} 
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-xs font-bold uppercase bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 px-2 py-0.5 rounded">{addr.type}</span>
                      </div>
              ...
              <button 
                ...
                className={`w-full py-3 border-2 border-dashed rounded-xl text-sm font-bold transition-all ${
                    isNewAddress 
              ...
              {isNewAddress && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 animate-in fade-in slide-in-from-top-2">
                  ...
                  <div className="md:col-span-2 flex items-center gap-2">
                    <input type="checkbox" id="saveAddr" className="rounded text-primary focus:ring-primary border-gray-300"/>
                    <label htmlFor="saveAddr" className="text-sm text-gray-600 dark:text-gray-400">Save this address for future orders</label>
                  </div>
                </div>
              )}
            </div>
             ...
             <div className="space-y-4">
                <div className="flex gap-4 overflow-x-auto pb-2 hide-scroll">
                   <button 
                     ...
                     className={`flex items-center gap-2 px-6 py-3 rounded-xl border font-bold text-sm whitespace-nowrap transition-all ${
                       paymentMethod === 'card' 
                ...
                {paymentMethod === 'cod' && (
                  <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-2xl border border-blue-100 dark:border-blue-800 flex items-start gap-3 animate-in fade-in slide-in-from-top-2">
