...
const coderabbit_client_js_1 = require("./coderabbit-client.js");
...
const coderabbit = new coderabbit_client_js_1.CodeRabbitClient(API_KEY);
    ...
    try {
        ...
        switch (name) {
            case "coderabbit_generate_report": {
                const { from, to, prompt, promptTemplate, groupBy } = args;
            ...
            case "coderabbit_security_scan": {
                ...
                const securityIssues = allIssues.filter(i => i.type.startsWith('security/') ||
                    i.severity === 'CRITICAL' ||
                    i.severity === 'HIGH');
            ...
            case "coderabbit_test_plan": {
                const { code, language, testType = 'all' } = args;
...
`;
            ...
            case "coderabbit_deployment_checklist": {
                const { projectType, environment, changes } = args;
