...
const EarningsChart: React.FC<EarningsChartProps> = ({ monthlyData, weeklyData, isDark }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl p-4 sm:p-6 shadow-sm border border-slate-100 dark:border-slate-700 h-[300px] sm:h-[400px] flex flex-col">
